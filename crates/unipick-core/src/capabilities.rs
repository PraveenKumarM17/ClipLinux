...
//!
//! UniPick must query what a session can actually do instead of branching on
...
/// A discrete desktop capability UniPick may need.
...
impl Capability {
    /// All capabilities known to this version of UniPick.
...
impl SupportLevel {
    /// Whether UniPick may attempt the capability.
