...
/// Operating system UniPick is running on.
#[derive(Clone, Debug, PartialEq, Eq, Hash, Serialize, Deserialize)]
#[non_exhaustive]
pub enum Platform {
    /// Linux and Linux-based systems, including most *nix desktops UniPick targets.
    Linux,
    /// Recognized but not a supported UniPick host.
